...
export class UpdateCommad extends BaseCommand implements IExecutableCommand {
   public async execute({
      parameters: [subjectName, environmentName, variables]
      ...
      await this.getRepository().updateEnvironment(
         subjectName,
         environmentName,
         variables
      )
      ...
      Logger.success(
         `Enivronment ${chalk.underline.bold(environmentName)} for subject ${chalk.underline.bold(subjectName)} updated successfully:\n`
      )
